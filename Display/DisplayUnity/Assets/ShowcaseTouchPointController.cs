...
public class ShowcaseTouchPointController : MonoBehaviour
{
    ...
    public void OnStartTouch(int id)
    {
        ...
        ShowcaseTemplateController.Instance.SetTemplateState(ShowcaseTemplateController.TemplateState.Loading);
    }
    ...
    public void OnAbortTouch(int id)
    {
        ...
        // change state
        ShowcaseTemplateController.Instance.SetTemplateState(ShowcaseTemplateController.TemplateState.Idle);
    ...
    public void OnEndTouch(int id)
    {
        ...
        // change state
        ShowcaseTemplateController.Instance.SetTemplateState(ShowcaseTemplateController.TemplateState.Scrolling);
    }
}
